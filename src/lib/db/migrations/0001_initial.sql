-- Shopping Cart & Shipping System — Initial Migration
-- Run via: POST /api/admin/migrate or drizzle-kit push
...
INSERT INTO shipping_classes (id, name, label, description, max_weight_oz, max_dimension_in) VALUES
  ('small-print', 'small-print', 'Small Print', 'Prints up to 16x20 — ships flat in rigid mailer', 128, 30),
  ('medium-painting', 'medium-painting', 'Medium Painting', 'Paintings up to 24x36 — boxed with foam corners', 640, 48),
  ('large-painting', 'large-painting', 'Large Painting', 'Paintings 36-60" — custom crated or oversized box', 1200, 72),
  ('oversized', 'oversized', 'Oversized', 'Art over 60" or 75 lbs — requires freight shipping', 99999, 999)
